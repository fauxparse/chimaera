import { ElementType, forwardRef, useLayoutEffect, useRef } from 'react';
...
import { SCROLLABLE_VARIANTS, ScrollableComponent } from './Scrollable.types';

import './Scrollable.css';

export const Scrollable: ScrollableComponent = forwardRef(({ as, children, ...props }, ref) => {
